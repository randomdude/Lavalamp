...
namespace netGui
{
    public interface ITransmitter : IDisposable
    {
		...
		Object doGetValue(transmitterDriver.sensorType thisSensorType,  Int16 nodeId, Int16 sensorId);
        ...
        void doSyncNetwork();
        transmitterDriver.sensorType doGetSensorType(Int16 nodeId, Int16 sensorId);
