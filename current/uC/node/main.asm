...
;foo
;
; Wait for the rising edge which signifies the start of a circle
;waitforsynclow:
;	btfsc PORTB, 5
;	goto waitforsynclow
;waitforsynchigh:
;	btfss PORTB, 5
;	goto waitforsynchigh
;
; Now set the laser on for a while.
;	bsf PORTA, 3
;
;	call veryshortdelay
;
...
;	goto foo
;
;; And shake our stepper slightly.
;servotest
;
;	bcf PORTA, 1
;	bsf PORTB, 0
...
;	call shortdelay
;
;	; Kill the laser after our wibble
;	call shortdelay
;	bcf PORTA, 3
;
;	goto foo
...
;	incf tmp1, f
;	btfss STATUS, Z
;	goto veryshortdelay2
;
;	return
;
; End servo test stuff
