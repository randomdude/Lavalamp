...
; SENSOR_(AUTOGEN_EVERY_SENSOR_ID)
		...
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_1
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_1, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_PIN_1
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_2
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_2, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_PIN_2
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_3
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_3, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_PIN_3
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_4
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_4, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_PIN_4
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_5
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_TRIS_5, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_PIN_5
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_CTL_1_PORT
			bcf SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_CTL_1_PORT, SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_CTL_1_PIN
		#endif
		#ifdef SENSOR_(AUTOGEN_EVERY_SENSOR_ID)_MULTILED_CTL_2_PORT
...
; And initialise any muxes
(AUTOGEN_BEGIN_REPLICATING_BLOCK)
#ifdef MUX_(AUTOGEN_EVERY_SENSOR_ID)_PRESENT

    	bsf STATUS, RP0 ; bank 1

		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_1, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_1
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_2, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_2
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_3, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_3
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_4, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_4
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_5, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_5
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_6, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_6
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_TRIS_7, MUX_(AUTOGEN_EVERY_SENSOR_ID)_PIN_7

		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_EN_1_TRIS, MUX_(AUTOGEN_EVERY_SENSOR_ID)_EN_1_PIN
		bcf MUX_(AUTOGEN_EVERY_SENSOR_ID)_EN_2_TRIS, MUX_(AUTOGEN_EVERY_SENSOR_ID)_EN_2_PIN
